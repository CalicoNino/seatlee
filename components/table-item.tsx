...
export function TableItem({
  ...
  const isOverCapacity =
    table.type === "table" && table.guests.length > table.seats;
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isHovered &&
          canAcceptGuest &&
          "ring-4 ring-green-500 ring-offset-2 scale-105 animate-pulse",
        isHovered &&
          !canAcceptGuest &&
          table.type === "table" &&
          "ring-4 ring-warning ring-offset-2",
        isOverCapacity && "border-warning shadow-warning/50",
        isHighlighted &&
          "ring-4 ring-blue-500 ring-offset-2 shadow-2xl shadow-blue-500/50 animate-pulse"
      )}
    >
      {renderSeats()}
      ...
      <div className="flex h-full w-full flex-col items-center justify-center p-4">
        {isEditingName ? (
          ...
          <div className="group/name flex items-center gap-1.5">
            <div className="font-serif text-base font-semibold text-card-foreground">
              {table.name || table.id}
            </div>
            <button
              onClick={(e) => {
